...
const SettingsNeDB = require('./lib/settingsnedb');
...
let settingsNeDB = new SettingsNeDB({ storagePath: Path.join(__dirname, Config.storageDirectory) });
let authentication = new Authentication(Object.assign({}, { userStore: userNeDB, sessionStore: sessionNeDB }, Config.authentication));
let api = new Api({ authentication: authentication, settingsStore: settingsNeDB });
